...
const joinForm =()=> {
    return (
      <div className=" w-full md:w-[380px] md:h-[833px] py-6 max-w-md mx-auto px-4 md:px-0">
        ...
        <form className="space-y-4">
          ...
          <select
            ...
            <option value=""  disabled selected hidden aria-label="Select a country">Select a country</option>
          ...
          <div className="flex items-center space-x-6">
            ...
            <label className="flex items-center">
              <input
                ...
                value="female"
                className="hidden peer"/>
              <span className="border border-gray-300 p-2 px-12 cursor-pointer rounded-md peer-checked:bg-blue-500 peer-checked:text-white text-gray-400">
                Female
              </span>
            </label>
          </div>
